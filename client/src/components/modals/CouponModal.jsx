    ...
    >
      ...
      <DialogContent dividers>
        ...
        <h4 className={classes.vipDesc}>
          You can find coupons by being active on our social media. You can find us on <a target="_blank" href="https://twitter.com/cryptosplashCasino">Twitter</a> or via <a href="https://discord.gg/AvnaPpnhJX" target="_blank">Discord</a>.
        </h4>
      </DialogContent>
      <DialogActions>
