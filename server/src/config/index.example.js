...
module.exports = {
  site: {
    ...
    // Site endpoints
    backend: {
      productionUrl: "https://api.cryptosplash.live",
      developmentUrl: "http://localhost:5000",
    },
    frontend: {
      productionUrl: "https://cryptosplash.live",
      developmentUrl: "http://localhost:3000",
    },
    adminFrontend: {
      productionUrl: "https://admin.cryptosplash.live",
      developmentUrl: "",
    },
  },
  ...
  database: {
    developmentMongoURI:
      "mongodb+srv://solphurlabs:jdzONjSi7hftNCAy@cluster0.u6qqnxb.mongodb.net/cryptosplash?retryWrites=true&w=majority", // MongoURI to use in development
    productionMongoURI: "mongodb://localhost/cryptosplash-live", // MongoURI to use in production
  },
